...
export const MODEL_COMPANIES: ModelCompany[] = [
    ...
    pillars: {
      ...
      G: {
        ...
        actions: [
          ...
          { id: 'terrafood-g-3', text: 'Faire vérifier les données ESG par un tiers externe.', tags: ['Financière'] },
        ],
      },
    },
  },
    ...
    pillars: {
      ...
      G: {
        ...
        actions: [
          ...
          { id: 'circularfab-g-3', text: 'Intégrer critères ESG dans les appels d’offres techniques.', tags: ['Impact', 'Financière'] },
        ],
      },
    },
  },
  {
  ...
  },
   {
    ...
    pillars: {
      ...
      G: {
        kpis: ['Score ESG intégré comme critère principal dans la sélection des sous-traitants.', 'Publication d’un rapport annuel sur les émissions par tonne-kilomètre.'],
        actions: [
          { id: 'cleanmove-g-1', text: 'Intégrer des clauses ESG strictes dans tous les contrats de transport.', tags: ['Financière', 'Impact'] },
  ...
  },
  {
    ...
    pillars: {
      ...
      S: {
        kpis: ['0 % d’investissements dans des entreprises controversées pour atteintes graves aux droits humains.', 'Formation de 100 % des gérants aux enjeux ESG.'],
        actions: [
      ...
      G: {
        ...
        actions: [
          { id: 'capital-g-1', text: 'Intégrer les critères ESG dans l’analyse fondamentale de chaque investissement.', tags: ['Financière'] },
